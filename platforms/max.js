// platforms/max.js - ТВОЙ РАБОЧИЙ КОД + ДОБАВЛЯЕМ ЗАГРУЗКУ ФАЙЛОВ
...
class MaxAPI {
    ...
    // ============================================================
    // ЗАГРУЗКА ФАЙЛА В MAX - НОВЫЙ МЕТОД ПО ДОКУМЕНТАЦИИ
    // ============================================================
    ...
    // ============================================================
    async uploadFileWithRetry(filePath, fileType = 'file', maxRetries = 3) {
        let lastError = null;
