...
class MaxAPI {
    constructor() {
        ...
        this.client = axios.create({
            baseURL: config.max.baseUrl || 'https://platform-api.max.ru',
            timeout: 30000,
            headers: {
        ...
        // Отдельный клиент для загрузки файлов (без baseURL)
    ...
    // ============================================================
    // ============== ЗАГРУЗКА МЕДИАФАЙЛА (ПО ДОКУМЕНТАЦИИ) ======
    // ============================================================
    /**
